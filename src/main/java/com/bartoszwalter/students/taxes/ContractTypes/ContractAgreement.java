...
public class ContractAgreement extends ContractConstants implements ContractType {
    ...
    public void calculateContractRates() {
        ...
        taxDecresingAmount = 0;
        ContractConstants.incomeCosts = (oBase * 20) / 100;
        ...
        double taxDeduct = incomeTaxAdvance;
        ...
        valuesMap.put("typUmowy", "UMOWA-ZLECENIE");
        ...
        valuesMap.put("zaliczkaPodatekDochodowy", incomeTaxAdvance);
